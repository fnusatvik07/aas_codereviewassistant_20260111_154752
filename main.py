# user_e30d2076/main.py
"""
Code Review Assistant - Auto-generated FastAPI service
...
app = FastAPI(
    ...
    description="Senior Software Engineer specializing in code review and technical documentation",
    version="1.0.0"
)
...
AGENT_CONFIG = {
    ...
    "system_prompt": """You are an expert Code Review Assistant with deep knowledge of software engineering best practices, design patterns, and documentation standards.
...
async def health_check():
    return {"status": "healthy", "agent": "Code Review Assistant"}
...
async def stream_agent_progress(request: QueryRequest) -> AsyncGenerator[str, None]:
    ...
    try:
        ...
        yield create_event("progress", {
            "message": "🤖 Starting Code Review Assistant...",
...
async def query_agent(request: QueryRequest):
    """
    Send a query/task to the Code Review Assistant (non-streaming)
    """
    try:
        # Create Claude Agent SDK options
        options = ClaudeAgentOptions(
